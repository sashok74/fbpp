...
int main(int argc, char** argv) {
    try {
        ...
        auto supportHeaderName = opts.supportHeader.filename().string();

        writeMainHeader(opts.outputHeader, supportHeaderName, querySpecs);
        writeSupportHeader(opts.supportHeader, querySpecs);
